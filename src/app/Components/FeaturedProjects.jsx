...
import { ARCHIVE_INDEX, FEATURED, PROJECT_COUNT } from '../lib/content';
  ...
  <section id="projects" className="relative scroll-mt-24 py-24 lg:py-32">
    <div className="mx-auto w-full max-w-7xl px-6 lg:px-12">
      <ChapterHeading
        ...
        kicker="Projects"
        title="Selected work"
        lead="Four projects that show how I work — platform engineering, applied AI in the cloud and on-device, and what I build after hours."
      />

      <ol className="border-t border-border-subtle">
        {FEATURED.map((project, index) => {
          const period = ARCHIVE_INDEX[project.id]?.period;
          return (
